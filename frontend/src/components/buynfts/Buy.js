...
async function buyNFT(tokenId) {
    try {
        ...
        toast.info("Buying this Product... Please Wait")
          ...
          <div className='buypage'>
            ...
            {/*<button className='buyBtn' onClick={buyNFT}>Buy</button>*/}
               { currAddress === data.owner || currAddress === data.seller ?
                <div className="owner">You are the owner of this Product</div>:<button onClick={() => buyNFT(tokenId)}className="buyBtn">{btnBusy ? <Spinner /> : "Buy Product"}</button>
            }
          </div>
           <ToastContainer
        theme="colored"
